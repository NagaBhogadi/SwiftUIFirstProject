...
//            )
                AngularGradient(
                    gradient: Gradient(colors: [Color(#colorLiteral(red: 0.9411764706, green: 0.9333333333, blue: 0.2470588235, alpha: 1)), Color(#colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1))]),
                    center: .topLeading,
